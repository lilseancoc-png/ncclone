  ...
  steps: [
    {
      ...
      structures: [
        { type: "tree", label: "root tree", root: { value: 3, left: { value: 4, left: { value: 1 }, right: { value: 2 } }, right: { value: 5 } } },
        { type: "tree", label: "subRoot", root: { value: 4, left: { value: 1 }, right: { value: 2 } } },
      ],
    },
    {
      description:
      ...
      structures: [
        { type: "tree", label: "root tree", root: { value: 3, highlight: "checked", left: { value: 4, left: { value: 1 }, right: { value: 2 } }, right: { value: 5 } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "root tree", root: { value: 3, left: { value: 4, highlight: "success", left: { value: 1, highlight: "success" }, right: { value: 2, highlight: "success" } }, right: { value: 5 } } },
        { type: "tree", label: "subRoot", root: { value: 4, highlight: "success", left: { value: 1, highlight: "success" }, right: { value: 2, highlight: "success" } } },
      ],
    },
    {
      description:
