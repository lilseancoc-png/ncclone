  ...
  steps: [
    {
      ...
      structures: [
        { type: "linkedlist", label: "list", nodes: [{ value: "d" }, { value: 1 }, { value: 2 }, { value: 3 }, { value: 4 }, { value: 5 }], pointers: [{ index: 0, label: "fast=slow" }] },
    ...
    },
    {
      ...
      structures: [
        { type: "linkedlist", label: "list", nodes: [{ value: "d" }, { value: 1 }, { value: 2 }, { value: 3, highlight: "active" }, { value: 4 }, { value: 5 }], pointers: [{ index: 0, label: "slow" }, { index: 3, label: "fast" }] },
    ...
    },
    {
      ...
      structures: [
        { type: "linkedlist", label: "list", nodes: [{ value: "d" }, { value: 1 }, { value: 2 }, { value: 3, highlight: "active" }, { value: 4, highlight: "found" }, { value: 5 }], pointers: [{ index: 3, label: "slow" }] },
