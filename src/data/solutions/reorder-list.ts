...
const solution: SolutionData = {
  ...
  steps: [
    ...
    },
    {
      ...
      structures: [
        { type: "linkedlist", label: "reordered", nodes: [{ value: 1, highlight: "success" }, { value: 5, highlight: "success" }, { value: 2, highlight: "success" }, { value: 4, highlight: "success" }, { value: 3, highlight: "success" }] },
