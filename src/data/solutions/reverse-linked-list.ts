  ...
  // ── Approach 1: Iterative ────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        structures: [
          { type: "array", label: "list", values: [1, 2, 3, 4, 5], highlights: { 0: "success", 1: "success", 2: "success", 3: "success", 4: "active" }, pointers: [{ index: 4, label: "curr" }] },
    ...
    steps: [
      {
        ...
        codeHighlightLines: [1, 2, 3],
        structures: [
          { type: "array", label: "linked list", values: [1, 2, 3, 4, 5] },
      ...
      },
      {
        ...
        codeHighlightLines: [5, 6],
        structures: [
          { type: "array", label: "progress", values: [1, 2, 3, 4, 5], highlights: { 3: "active", 4: "success" } },
      ...
      },
      {
        ...
        codeHighlightLines: [5, 6],
        structures: [
          { type: "array", label: "progress", values: [1, 2, 3, 4, 5], highlights: { 2: "active", 3: "success", 4: "success" } },
      ...
      },
      {
        ...
        codeHighlightLines: [5, 6],
        structures: [
          { type: "array", label: "progress", values: [1, 2, 3, 4, 5], highlights: { 0: "active", 1: "success", 2: "success", 3: "success", 4: "success" } },
