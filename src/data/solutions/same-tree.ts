  ...
  steps: [
    {
      ...
      structures: [
        { type: "tree", label: "tree p", nodes: [{ value: 1 }, { value: 2 }, { value: 3 }] },
        { type: "tree", label: "tree q", nodes: [{ value: 1 }, { value: 2 }, { value: 3 }] },
      ],
    },
    {
      description:
      ...
      structures: [
        { type: "tree", label: "tree p", nodes: [{ value: 1, highlight: "success" }, { value: 2 }, { value: 3 }] },
        { type: "tree", label: "tree q", nodes: [{ value: 1, highlight: "success" }, { value: 2 }, { value: 3 }] },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "tree p", nodes: [{ value: 1, highlight: "success" }, { value: 2, highlight: "success" }, { value: 3 }] },
        { type: "tree", label: "tree q", nodes: [{ value: 1, highlight: "success" }, { value: 2, highlight: "success" }, { value: 3 }] },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "tree p", nodes: [{ value: 1, highlight: "success" }, { value: 2, highlight: "success" }, { value: 3, highlight: "success" }] },
        { type: "tree", label: "tree q", nodes: [{ value: 1, highlight: "success" }, { value: 2, highlight: "success" }, { value: 3, highlight: "success" }] },
