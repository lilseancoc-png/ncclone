  ...
  steps: [
    {
      ...
      structures: [
        { type: "array", label: "BST", values: [6, 2, 8, 0, 4, 7, 9] },
    ...
    },
    {
      ...
      structures: [
        { type: "array", label: "BST", values: [6, 2, 8, 0, 4, 7, 9], highlights: { 0: "success", 1: "active", 2: "active" } },
    ...
    },
    {
      ...
      structures: [
        { type: "array", label: "BST", values: [6, 2, 8, 0, 4, 7, 9], highlights: { 0: "success" } },
