  ...
  steps: [
    {
      ...
      structures: [
        { type: "tree", label: "Tree", root: { value: 3, left: { value: 1, left: { value: 3 }, right: null }, right: { value: 4, left: { value: 1 }, right: { value: 5 } } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "Tree", root: { value: 3, highlight: "success", left: { value: 1, highlight: "found", left: { value: 3, highlight: "success" }, right: null }, right: { value: 4, left: { value: 1 }, right: { value: 5 } } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "Tree", root: { value: 3, highlight: "success", left: { value: 1, highlight: "found", left: { value: 3, highlight: "success" }, right: null }, right: { value: 4, highlight: "success", left: { value: 1, highlight: "found" }, right: { value: 5, highlight: "success" } } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "Tree (good=green, not good=red)", root: { value: 3, highlight: "success", left: { value: 1, highlight: "found", left: { value: 3, highlight: "success" }, right: null }, right: { value: 4, highlight: "success", left: { value: 1, highlight: "found" }, right: { value: 5, highlight: "success" } } } },
