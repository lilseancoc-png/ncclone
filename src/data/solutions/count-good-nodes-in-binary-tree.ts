  ...
  steps: [
    {
      ...
      structures: [
        { type: "array", label: "tree", values: [3, 1, 4, 3, "—", 1, 5] },
    ...
    },
    {
      ...
      structures: [
        { type: "array", label: "tree", values: [3, 1, 4, 3, "—", 1, 5], highlights: { 0: "success", 1: "found", 3: "success" } },
    ...
    },
    {
      ...
      structures: [
        { type: "array", label: "tree", values: [3, 1, 4, 3, "—", 1, 5], highlights: { 0: "success", 1: "found", 2: "success", 3: "success", 5: "found", 6: "success" } },
