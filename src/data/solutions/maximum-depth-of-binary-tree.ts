    ...
    steps: [
      {
        ...
        structures: [
          { type: "array", label: "tree (level order)", values: [3, 9, 20, "—", "—", 15, 7] },
      ...
      },
      {
        ...
        structures: [
          { type: "array", label: "tree", values: [3, 9, 20, "—", "—", 15, 7], highlights: { 1: "active" } },
      ...
      },
      {
        ...
        codeHighlightLines: [4, 5, 6],
        structures: [
          { type: "array", label: "tree", values: [3, 9, 20, "—", "—", 15, 7], highlights: { 2: "active", 5: "checked", 6: "checked" } },
      ...
      },
      {
        ...
        structures: [
          { type: "array", label: "tree", values: [3, 9, 20, "—", "—", 15, 7], highlights: { 0: "success", 1: "success", 2: "success", 5: "success", 6: "success" } },
    ...
    steps: [
      {
        ...
        structures: [
          { type: "array", label: "tree", values: [3, 9, 20, "—", "—", 15, 7] },
      ...
      },
      {
        ...
        structures: [
          { type: "array", label: "tree", values: [3, 9, 20, "—", "—", 15, 7], highlights: { 0: "success" } },
      ...
      },
      {
        ...
        structures: [
          { type: "array", label: "tree", values: [3, 9, 20, "—", "—", 15, 7], highlights: { 0: "success", 1: "success", 2: "success" } },
