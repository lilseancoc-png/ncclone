  ...
  steps: [
    {
      ...
      structures: [
        { type: "tree", label: "BST", root: { value: 3, left: { value: 1, right: { value: 2 } }, right: { value: 4 } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "BST", root: { value: 3, left: { value: 1, highlight: "active", right: { value: 2 } }, right: { value: 4 } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "BST", root: { value: 3, left: { value: 1, highlight: "success", right: { value: 2 } }, right: { value: 4 } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "BST (inorder: 1,2,3,4)", root: { value: 3, highlight: "checked", left: { value: 1, highlight: "success", right: { value: 2, highlight: "checked" } }, right: { value: 4, highlight: "checked" } } },
