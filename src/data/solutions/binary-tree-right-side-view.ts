  ...
  steps: [
    {
      ...
      structures: [
        { type: "tree", label: "Tree", root: { value: 1, left: { value: 2, left: null, right: { value: 5 } }, right: { value: 3, left: null, right: { value: 4 } } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "Tree", root: { value: 1, highlight: "success", left: { value: 2, left: null, right: { value: 5 } }, right: { value: 3, left: null, right: { value: 4 } } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "Tree", root: { value: 1, highlight: "success", left: { value: 2, highlight: "checked", left: null, right: { value: 5 } }, right: { value: 3, highlight: "success", left: null, right: { value: 4 } } } },
    ...
    },
    {
      ...
      structures: [
        { type: "tree", label: "Tree", root: { value: 1, highlight: "success", left: { value: 2, highlight: "success", left: null, right: { value: 5, highlight: "checked" } }, right: { value: 3, highlight: "success", left: null, right: { value: 4, highlight: "success" } } } },
